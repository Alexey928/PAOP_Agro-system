...
export class CultureContaynedHistoryService {
  constructor(
      @InjectRepository(CultureContaynedHistoryEntity)
      private readonly repository:Repository<CultureContaynedHistoryEntity>
  ){}
  async create(createCultureContaynedHistoryDto: CreateCultureContaynedHistoryDto) {
    const newHistory = {
      field:{id:createCultureContaynedHistoryDto.fieldId},
